...
# Compatibility bridge between CollectedFile (schemas.py) and CollectedArtifact used by the snapper
@dataclass
...
class SnapshotManifest(WireModel):
    ...
    # Kept flexible to accommodate either representation.
...
class SnapshotResult(WireModel):
    ...
    # Exclude payload by default in JSON/log persistence
